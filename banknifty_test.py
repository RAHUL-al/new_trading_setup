...
market_open_time = datetime.now().replace(hour=9, minute=14, second=50, microsecond=0)
# current_time = datetime.now().replace(hour=10, minute=15, second=0, microsecond=0)
market_close_time = datetime.now().replace(hour=23, minute=15, second=0, microsecond=0)
...
#     try:
#         start_process()
#         time.sleep(5)  # Sleep for 1 minute before running again
#     except Exception as e:
#         print(f"An error occurred: {e}")
#         print("Restarting the process...")
#         time.sleep(20)  # Sleep for 5 seconds before restarting
#         continue
